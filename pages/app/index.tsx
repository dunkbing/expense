...
export default function Home({ user }) {
	...
	const { data: expensesData = [], isLoading: isExpensesLoading } = useSWR<expenses[]>(
	...
	const subscriptionDataForLegend = useMemo(() => extractCategoriesFromData(subscriptionsData), [subscriptionsData]);

	const chartDataForSubscription = useMemo(() => extractSubscriptionData(subscriptionsData), [subscriptionsData]);
					...
					<div className="flex items-center font-medium">
						<div className="ranger-picker mr-2 flex w-[calc(100%-51px)] items-center sm:mr-4">
							...
							<div className="col-md-8">
								<h3 className="fst-italic border-bottom mb-4 pb-4">Adsense ads</h3>
								{isClient && (
									<>
										<ins
											className="adsbygoogle"
											style={{ display: 'block' }}
											data-ad-client="ca-pub-6254144234932394"
											data-ad-slot="8027486337"
											data-ad-format="auto"
