...
const initialState = { loading: false, email: '', subject: '', message: '', sent: false };
...
export default function Contact() {
	...
	return (
		<>
			<Head>
				<title>Quanlychitieu.fun – Contact Us</title>
					...
					<form
						...
						onSubmit={async (event) => {
							...
							await fetch('/api/contact', {
								...
								setState({ ...state, ...initialState, sent: true, loading: false });
							});
						}}
					>
						<div>
							<label className="mb-2 block text-sm font-medium dark:text-gray-300">Địa chỉ Email</label>
							<input
