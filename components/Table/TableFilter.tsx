...
export default function TableFilter({ filterKey = filterMap.all, onFilterChange }: Props) {
	return (
		<div className="font-xs font-xs mr-4 flex">
			<span className="mr-2 flex items-center font-medium text-zinc-800 max-xs:hidden">
			...
			<select
				name="table-filter"
				className="inline-flex w-[112px] items-center rounded-md border border-gray-300 bg-white px-[9px] py-[6px] text-sm font-medium text-black shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 xs:w-[120px]"
				onChange={(event) => {
