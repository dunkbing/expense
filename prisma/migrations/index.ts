...
export const defaultProgressReport: ProgressReportCallback = ({ model, totalCount, processed, performance }) => {
...
export async function migrate(
	...
	const [processedsubscriptions, processedexpenses, processedincome, processedinvestments] = await Promise.all([
